export const curriculumWeeks = [
  {
    ...
    sessionATheme:
      "How AI is restructuring org charts in 6 industries with evidence from real enterprise deployments",
    sessionABody: [
    ...
    deliverable:
      "Industry Choice Decision Matrix with 2 target industries and 3 target roles ranked by viability score.",
    asyncContent:
    ...
    activities: {
      ...
      worksheetPrompt:
        "Use job demand, skills-fit, and automation threat to choose the strongest near-term direction."
    }
  },
  {
    id: 2,
    ...
    sessionATheme:
      "Live technical walk-through of AI use cases from 4 industries shown with actual code and tools",
    sessionABody: [
    ...
    activities: {
      ...
      worksheetPrompt:
        "Document the problem, AI technique, business owner, and observed career relevance for each use case."
    }
  },
  {
    id: 3,
    ...
    sessionATheme:
      "The 5 AI-era role archetypes with real JDs, salary data, and transition paths",
    sessionABody: [
  ...
  },
  {
    ...
    sessionATheme:
      "How hiring actually works inside enterprises and what this means for your job search strategy",
    sessionABody: [
  ...
  },
  {
    ...
    sessionATheme:
      "The 3-Layer Skill Stack built per branch, per archetype, and per target industry",
    sessionABody: [
  ...
  },
  {
    ...
    sessionATheme:
      "What makes a portfolio project credible to an enterprise hiring manager",
    sessionABody: [
  ...
  },
  {
    ...
    sessionATheme:
      "How to get your first break without campus placement using off-campus channels that actually work",
    sessionABody: [
  ...
  },
  {
    ...
    sessionATheme:
      "Building a concrete 90-day plan with milestones and dependencies",
    sessionABody: [
